...
export const HomeComponent: React.FC = () => {
  ...
  const {
    businessState, setBusinessState, entertainmentState, setEntertainmentState, healthState, setHealthState, scienceState, setScienceState, sportsState, setSportsState, technologyState, setTechnologyState,
    ...
    <>
      ...
      <div className='flex-container'>
        ...
        <div className='flex-item-center'>
          <CategoryHeader
            title={'Entertainment'}
            onClick={() => categoryDetailPage('entertainment', entertainmentState)} />
          {/* <HorizontalLine color={'#EEEEEE'} height={2} /> */}
